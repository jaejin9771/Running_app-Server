...
import cse.jaejin.running.post.PostRepository; // PostLike 카운트 업데이트용
import cse.jaejin.running.sharedCourse.SharedCourseRepository; // SharedCourseLike 카운트 업데이트용
